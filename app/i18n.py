...
LANGUAGES = {
    "en": {
        ...
        "custom_sync_settings_section": "Scheduled Sync Task (Rclone)",
        "custom_sync_enabled_label": "Enable Scheduled Sync",
        "custom_sync_local_path_label": "Local Path to Sync",
        "custom_sync_local_path_placeholder": "e.g., /app/tmp/data/downloads",
        "custom_sync_remote_path_label": "Remote Destination Path",
        "custom_sync_remote_path_placeholder": "e.g., remote:backup/my-files",
        "custom_sync_interval_label": "Sync Interval (Minutes)",
        ...
        "redis_url_text": "Used for centralized logging. Leave empty to disable.",
    ...
    "zh": {
        ...
        "custom_sync_settings_section": "定时同步任务 (Rclone)",
        "custom_sync_enabled_label": "启用定时同步",
        "custom_sync_local_path_label": "本地同步路径",
        "custom_sync_local_path_placeholder": "例如：/app/tmp/data/downloads",
        "custom_sync_remote_path_label": "远程目标路径",
        "custom_sync_remote_path_placeholder": "例如：remote:backup/my-files",
        "custom_sync_interval_label": "同步间隔 (分钟)",
